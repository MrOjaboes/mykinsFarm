...
<body class="bg-gray-5">
    ...
    <div class="main-wrapper box-layout-width-2">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.html"><img src="/guest/assets/images/logo/logo.png" alt="logo"></a>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-3">
                                    <div class="main-categori-wrap main-categori-wrap-modify-2">
                                        <a class="categori-show" href="#">All Department <i class="icon-arrow-down icon-right"></i></a>
                                        <div class="category-menu-2 categori-hide">
                                            <nav>
                                                <ul>
            ...
            <div class="clickalbe-sidebar-wrap">
                ...
                <div class="mobile-header-content-area">
                    ...
                    <div class="main-categori-wrap mobile-menu-wrap mobile-header-padding-border-3">
                        <a class="categori-show green" href="#">
        ...
        <div class="slider-area pt-30">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-8 ms-auto">
                        <div class="hero-slider-active-1 nav-style-1 nav-style-1-modify nav-style-1-green-2 dot-style-2 dot-style-2-position-5 dot-style-2-active-green-2 bg-gray-7">
                            <div class="single-hero-slider slider-height-4 custom-d-flex custom-align-item-center single-animation-wrap bg-img res-white-overly-xs" style="background-image:url(/guest/assets/images/slider/hm-8-slider-1.jpg);">
                                <div class="row g-0 align-items-center slider-animated-1">
                                    <div class="col-12">
                                        <div class="hero-slider-content-6">
                                            <h5 class="animated">New Arrivals</h5>
                                            <h1 class="animated">Native Fuel <br>Whey</h1>
                                            <p class="animated">Discover our collection with leather simple backpacks. Less is more never out trend.</p>
                                            <div class="btn-style-1">
                                                <a class="animated btn-1-padding-4 btn-1-green-2 btn-1-font-14" href="product-details.html">Explore Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row flex-row-reverse">
                <div class="col-lg-9">
                        ...
                        <div class="product-categories-slider-2 nav-style-5">
                            <div class="product-plr-1">
                                <div class="single-product-wrap">
                                    <div class="product-img product-img-border border-green-2 mb-20">
                                        <a href="shop.html">
                                            <img src="/guest/assets/images/product/product-50.png" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content-categories-2 product-content-green-2 text-center">
                                        <h5><a href="shop.html" class="btn" style="border-radius:3rem;">Fashion</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="product-plr-1">
                                <div class="single-product-wrap">
                                    <div class="product-img product-img-border border-green-2 mb-20">
                                        <a href="shop.html">
                                            <img src="/guest/assets/images/product/product-51.png" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content-categories-2 product-content-green-2 text-center">
                            ...
                            <div class="product-plr-1">
                                <div class="single-product-wrap">
                                    <div class="product-img product-img-border border-green-2 mb-20">
                                        <a href="shop.html">
                                            <img src="/guest/assets/images/product/product-52.png" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content-categories-2 product-content-green-2 text-center">
                            ...
                            <div class="product-plr-1">
                                <div class="single-product-wrap">
                                    <div class="product-img product-img-border border-green-2 mb-20">
                                        <a href="shop.html">
                                            <img src="/guest/assets/images/product/product-53.png" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content-categories-2 product-content-green-2 text-center">
                            ...
                            <div class="product-plr-1">
                                <div class="single-product-wrap">
                                    <div class="product-img product-img-border border-green-2 mb-20">
                                        <a href="shop.html">
                                            <img src="/guest/assets/images/product/product-54.png" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content-categories-2 product-content-green-2 text-center">
                            ...
                            <div class="product-plr-1">
                                <div class="single-product-wrap">
                                    <div class="product-img product-img-border border-green-2 mb-20">
                                        <a href="shop.html">
                                            <img src="/guest/assets/images/product/product-55.png" alt="">
                                        </a>
                                    </div>
                                    <div class="product-content-categories-2 product-content-green-2 text-center">
                    ...
                    <div class="product-area pb-55">
                        <div class="section-title-tab-wrap border-bottom-3 mb-40 pb-20">
                            <div class="section-title-7">
                                <h2>trending products</h2>
                            </div>
                            <div class="tab-style-3 tab-style-3-green-2 nav">
                        ...
                        <div class="tab-content jump">
                            <div id="product-1" class="tab-pane active">
                                <div class="product-slider-active-6 dot-style-2 dot-style-2-position-static dot-style-2-mrg-2 dot-style-2-active-green-2">
                                    <div class="product-plr-2">
                                        <div class="single-product-wrap-2 mb-25">
                                            <div class="product-img-2">
                                                <a href="product-details.html"><img src="/guest/assets/images/product/product-56.jpg" alt=""></a>
                                            </div>
                                            <div class="product-content-3">
                                                <span>baby</span>
                                                <h4><a href="product-details.html">Advantage Baby Milk Bottle</a></h4>
                                                ...
                                                <div class="pro-price-action-wrap">
                                                    ...
                                                    <div class="product-action-3 pro-action-3-green-2">
                                    ...
                                    <div class="product-plr-2">
                                        <div class="single-product-wrap-2 mb-25">
                                            <div class="product-img-2">
                                                <a href="product-details.html"><img src="/guest/assets/images/product/product-57.jpg" alt=""></a>
                                            </div>
                                            <div class="product-content-3">
                                                <span>furniture</span>
                                                <h4><a href="product-details.html">White Plastic Chair</a></h4>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-2">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-2">
                                        <div class="single-product-wrap-2 mb-25">
                                            <div class="product-img-2">
                                                <a href="product-details.html"><img src="/guest/assets/images/product/product-58.jpg" alt=""></a>
                                            </div>
                                            <div class="product-content-3">
                                                <span>fashion</span>
                                                <h4><a href="product-details.html">Herchoe Backpack</a></h4>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-2">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-2">
                                        <div class="single-product-wrap-2 mb-25">
                                            <div class="product-img-2">
                                                <a href="product-details.html"><img src="/guest/assets/images/product/product-59.jpg" alt=""></a>
                                            </div>
                                            <div class="product-content-3">
                                                <span>beauty</span>
                                                <h4><a href="product-details.html">Ciate London Makeup Beauty</a></h4>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-2">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-2">
                                        <div class="single-product-wrap-2 mb-25">
                                            <div class="product-img-2">
                                                <a href="product-details.html"><img src="/guest/assets/images/product/product-60.jpg" alt=""></a>
                                            </div>
                                            <div class="product-content-3">
                                                <span>baby</span>
                                                <h4><a href="product-details.html">Pampers Baby-dry Diapers & Small Gifts</a></h4>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-2">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-2">
                                        <div class="single-product-wrap-2 mb-25">
                                            <div class="product-img-2">
                                                <a href="product-details.html"><img src="/guest/assets/images/product/product-61.jpg" alt=""></a>
                                            </div>
                                            <div class="product-content-3">
                                                <span>electric</span>
                                                <h4><a href="product-details.html">DJ Spark II Camera 360</a></h4>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-2">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                    ...
                    <div class="banner-area pb-55">
                        <div class="banner-wrap">
                            <div class="banner-img banner-img-zoom">
                                <a href="product-details.html"><img src="/guest/assets/images/banner/banner-22.jpg" alt=""></a>
                            </div>
                            <div class="banner-content-11 banner-content-11-modify-2">
                    ...
                    <div class="product-area pb-115">
                        <div class="section-title-tab-wrap border-bottom-3 mb-30 pb-20">
                            ...
                            <div class="tab-style-8 nav tab-res-mrg">
                                ...
                                <a href="#product-7" data-bs-toggle="tab">Computer </a>
                                <a href="#product-8" data-bs-toggle="tab">Jewelry </a>
                                <a href="#product-9" data-bs-toggle="tab">Apparel </a>
                                <a href="#product-10" data-bs-toggle="tab"> Cookware </a>
                            </div>
                        </div>
                        <div class="tab-content jump">
                            <div id="product-6" class="tab-pane active">
                                <div class="product-slider-active-7 dot-style-2 dot-style-2-position-static dot-style-2-active-green-2">
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-62.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-67.jpg" alt="">
                                                </a>
                                                <div class="product-action-2 tooltip-style-2">
                                                    <button title="Wishlist"><i class="icon-heart"></i></button>
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-size-fullscreen icons"></i></button>
                                            ...
                                            <div class="product-content-wrap-3">
                                                <div class="product-content-categories">
                                                    <a class="blue" href="shop.html">gap</a>
                                                </div>
                                                <h3><a class="blue" href="product-details.html">Brown T-shirt</a></h3>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-4">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-63.jpg" alt="">
                                                </a>
                                                <div class="product-action-2 tooltip-style-2">
                                                    <button title="Wishlist"><i class="icon-heart"></i></button>
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-size-fullscreen icons"></i></button>
                                    ...
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-72.jpg" alt="">
                                                </a>
                                                <div class="product-action-2 tooltip-style-2">
                                                    <button title="Wishlist"><i class="icon-heart"></i></button>
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-size-fullscreen icons"></i></button>
                                            ...
                                            <div class="product-content-wrap-3">
                                                <div class="product-content-categories">
                                                    <a class="blue" href="shop.html">Comet</a>
                                                </div>
                                                <h3><a class="blue" href="product-details.html">Comet Rice Cooker</a></h3>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-4">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-64.jpg" alt="">
                                                </a>
                                                <div class="product-action-2 tooltip-style-2">
                                                    <button title="Wishlist"><i class="icon-heart"></i></button>
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-size-fullscreen icons"></i></button>
                                    ...
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-69.jpg" alt="">
                                                </a>
                                                <div class="product-action-2 tooltip-style-2">
                                                    <button title="Wishlist"><i class="icon-heart"></i></button>
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-size-fullscreen icons"></i></button>
                                            ...
                                            <div class="product-content-wrap-3">
                                                <div class="product-content-categories">
                                                    <a class="blue" href="shop.html">adidas</a>
                                                </div>
                                                <h3><a class="blue" href="product-details.html">Adidas Grey Sport Sneaker</a></h3>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-4">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-65.jpg" alt="">
                                                </a>
                                                <div class="product-action-2 tooltip-style-2">
                                                    <button title="Wishlist"><i class="icon-heart"></i></button>
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-size-fullscreen icons"></i></button>
                                            ...
                                            <div class="product-content-wrap-3">
                                                ...
                                                <h3><a class="blue" href="product-details.html">Norda Norda Tab A</a></h3>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-4">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                                    ...
                                    <div class="product-plr-1">
                                        <div class="single-product-wrap mb-60">
                                            <div class="product-img product-img-zoom mb-15">
                                                <a href="product-details.html">
                                                    <img src="/guest/assets/images/product/product-80.jpg" alt="">
                                                </a>
                                                <div class="product-action-2 tooltip-style-2">
                                                    <button title="Wishlist"><i class="icon-heart"></i></button>
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon-size-fullscreen icons"></i></button>
                                            ...
                                            <div class="product-content-wrap-3">
                                                ...
                                                <h3><a class="blue" href="product-details.html">Pamper Baby-dry Disapers</a></h3>
                                                <div class="product-rating-wrap-2">
                                                    <div class="product-rating-4">
                                                        <i class="icon_star"></i>
                                                        <i class="icon_star"></i>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="banner-area mb-60">
                        <div class="banner-wrap">
                            <div class="banner-img banner-img-zoom">
                                <a href="product-details.html"><img src="/guest/assets/images/banner/banner-21.jpg" alt=""></a>
                            </div>
                            <div class="banner-content-18">
                                <span>mega sale</span>
                                <h2><span>50%</span> OFF <br>for Autumn</h2>
                                <p>Backpack BYORK, don’t miss outvin this mage sale</p>
                            </div>
                        </div>
                    </div>
                    <div class="sidebar-product-area mb-20">
                        <div class="section-title-7 border-bottom-3 mb-25 pb-15">
                            <h2>Featured Products</h2>
                        </div>
                        <div class="sidebar-product-active nav-style-5">
                            <div class="single-sidebar-product">
                                <div class="sidebar-product-img">
                                    <a href="product-details.html"><img src="/guest/assets/images/product/product-77.jpg" alt=""></a>
                                </div>
                                <div class="sidebar-product-content">
                                    <h5><a href="product-details.html">Nine West Grey Watches</a></h5>
                            ...
                            <div class="single-sidebar-product">
                                <div class="sidebar-product-img">
                                    <a href="product-details.html"><img src="/guest/assets/images/product/product-78.jpg" alt=""></a>
                                </div>
                                <div class="sidebar-product-content">
                                    <h5><a href="product-details.html">DJ Spark II Quacopter White Color</a></h5>
                                    <div class="sidebar-product-price">
                            ...
                            <div class="single-sidebar-product">
                                <div class="sidebar-product-img">
                                    <a href="product-details.html"><img src="/guest/assets/images/product/product-79.jpg" alt=""></a>
                                </div>
                                <div class="sidebar-product-content">
                                    <h5><a href="product-details.html">Black Super Plastic Chair IKEA</a></h5>
                                    <div class="sidebar-product-price">
                                        <span>$60.65</span>
                                    </div>
                                </div>
                    ...
                    <div class="sidebar-blog-area mb-30">
                        <div class="section-title-7 border-bottom-3 mb-25 pb-15">
                            <h2>news</h2>
                        </div>
                        <div class="sidebar-blog-active nav-style-5">
                            <div class="single-sidebar-blog">
                                <div class="sidebar-blog-img">
                                    <a href="blog-details.html"><img src="/guest/assets/images/blog/blog-4.jpg" alt=""></a>
                                </div>
                                <div class="sidebar-blog-content">
                                    <h5><a href="blog-details.html">Basic colord mixed - trendind 2020</a></h5>
                                    <span>Sep 5th, 2020</span>
                                </div>
                            </div>
                            <div class="single-sidebar-blog">
                                <div class="sidebar-blog-img">
                                    <a href="blog-details.html"><img src="/guest/assets/images/blog/blog-5.jpg" alt=""></a>
                                </div>
                                <div class="sidebar-blog-content">
                                    <h5><a href="blog-details.html">Five things you only know if you’re Chanel's</a></h5>
                    ...
                    <div class="testimonial-area testimonial-border-1 testimonial-padding-1 mb-60">
                        <div class="testimonial-active-1 dot-style-2 dot-style-2-position-static dot-style-2-left-0 dot-style-2-active-green-2">
                            <div class="single-testimonial">
                                <img src="/guest/assets/images/icon-img/quotes-icon.png" alt="">
                                <p>Norda has completely surpassed our expectations. Tech should be nominated for service of the year.</p>
                    ...
                    <div class="tag-area mb-60">
                        <div class="section-title-7 border-bottom-3 pb-15 mb-25">
                            <h2>popular tags</h2>
                        </div>
                        <div class="tag-wrap">
                            <a href="#">Game</a>
        ...
        {{-- News letter --}}
        <div class="subscribe-area bg-green-2 pt-60 pb-60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-5">
                        <div class="section-title-3 section-title-3-white">
                        ...
                        <div id="mc_embed_signup" class="subscribe-form-2">
                            <form id="mc-embedded-subscribe-form" class="validate subscribe-form-style-2" novalidate="" target="_blank" name="mc-embedded-subscribe-form" method="post" action="https://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef">
                                <div id="mc_embed_signup_scroll" class="mc-form-2">
                                    ...
                                    <div class="clear-2 clear-2-green-2">
                                ...
                                <div class="contact-info-2">
                                    <div class="single-contact-info-2">
                                        ...
                                        <div class="contact-info-2-content">
                                            ...
                                            <h3 class="green-2">(365) 8635 56-24-02 </h3>
                                        </div>
                                    </div>
                                    <div class="single-contact-info-2">
                                        <div class="contact-info-2-icon">
