...
@section('content')
    ...
    <div class="product-area pb-110 pt-5" style="background-color:white;">
        <div class="container">
            <div class="section-title mb-45">
                <h2>Super Collections</h2>
            </div>
            <div class="row grid" style="padding-top: 2rem;">
                @foreach ($first_row as $product)
                    <div class="col-md-3">
                        <div class="card" style=" ">
                            <div>
                                <a href="{{ route('product.details', $product->id) }}"><img
    ...
    {{-- Second row --}}
    <div class="product-area pb-110 pt-2" style="background-color:white;">
        <div class="container">
            <div class="section-title mb-45">
